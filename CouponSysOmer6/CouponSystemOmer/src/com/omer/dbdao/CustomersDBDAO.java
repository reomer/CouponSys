...
public class CustomersDBDAO implements CustomersDAO {
	...
	private static final String ADD_QUERY = "INSERT INTO `coupon_sys`.`CUSTOMERS` (`id`,`first_name`, `last_name`, `email`,`password`) VALUES (?,?,?,?,?);\n"
			+ "";
	...
	private static final String IS_CUSTOMER_EXIST_QUERY = "SELECT*FROM coupon_sys.CUSTOMERS WHERE email= ? AND password= ?";
	private static final String IS_CUSTOMER_EXIST_ID = "SELECT * FROM coupon_sys.CUSTOMERS WHERE id=?";
	...
	public boolean isCustomerExistID(int customerID) {
		...
		try {
			conn = ConnectionPool.getInstance().getConnection();
			PreparedStatement statement = conn.prepareStatement(IS_CUSTOMER_EXIST_ID);
